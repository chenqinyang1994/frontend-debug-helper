...
document.addEventListener('DOMContentLoaded', () => {
  ...
  console.log(`Detected OS: ${osName}, Platform: ${platform}, Shortcut: ${shortcutKey}`);
  ...
  document.getElementById('docsBtn').addEventListener('click', () => {
    // 打开文档页面
    chrome.tabs.create({
      url: 'https://github.com/your-repo/frontend-debug-helper'
    });
  });
  ...
  document.getElementById('troubleshootLink').addEventListener('click', (e) => {
    e.preventDefault();
    chrome.tabs.create({
      url: 'https://github.com/your-repo/frontend-debug-helper#troubleshooting'
    });
  });
